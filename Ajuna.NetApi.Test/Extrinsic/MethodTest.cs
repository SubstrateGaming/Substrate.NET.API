...
namespace Ajuna.NetApi.Test.Extrinsic
{
    public class MethodTest
    {
        ...
        {
            Assert.True("0x0602".Equals(Utils.Bytes2HexString(new Method(0x06, 0x02).Encode()),
                StringComparison.InvariantCultureIgnoreCase));

            Assert.True("0x06000100000000000000".Equals(
            ...
            Assert.AreEqual("0xd43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d".ToUpper(),
            ...
            Assert.True("0x0400ffd43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d9101".Equals(
