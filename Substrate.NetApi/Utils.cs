...
namespace Substrate.NetApi
{
    ...
    public class Utils
    {
        ...
        /// <param name="Key">The secret key for the symmetric algorithm to use for encryption.</param>
        /// <param name="IV">The initialization vector (IV) for the symmetric algorithm to use for encryption.</param>
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public static byte[] AesEncryptString(string plainText, byte[] Key, byte[] IV)
        {
            // Check arguments.
        ...
        /// <param name="Key">The secret key for the symmetric algorithm to use for decryption.</param>
        /// <param name="IV">The initialization vector (IV) for the symmetric algorithm to use for decryption.</param>
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public static string AesDecryptBytes(byte[] cipherText, byte[] Key, byte[] IV)
        {
            // Check arguments.
