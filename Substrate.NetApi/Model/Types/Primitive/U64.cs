...
{
    public class U64 : BasePrim<ulong>, IComparable, IComparable<U64>, IEquatable<U64>
    {
        public U64()
        { }
        ...
        {
            if (obj is U64 validObj)
                return CompareTo(validObj);

            throw new InvalidOperationException($"{nameof(obj)} is not a valid {nameof(U64)} instance");
        }
