...
namespace Ajuna.NetApi.Model.Types.Metadata.V13
{
    ...
    public class StorageEntryMetadata : BaseType
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            StorageType = new BaseEnumExt<Storage.Type, DecodeDifferentStr, StorageEntryTypeMap, StorageEntryTypeDoubleMap, StorageEntryTypeNMap, BaseVoid, BaseVoid, BaseVoid, BaseVoid, BaseVoid>();
        ...
        public BaseEnumExt<Storage.Type, DecodeDifferentStr, StorageEntryTypeMap, StorageEntryTypeDoubleMap, StorageEntryTypeNMap, BaseVoid, BaseVoid, BaseVoid, BaseVoid, BaseVoid> StorageType { get; private set; }
