...
namespace Ajuna.NetApi
{
    ...
    public struct CompactInteger : IEncodable
    {
        ...
        /// <returns> The result of the operation. </returns>
        public static bool operator <(CompactInteger self, CompactInteger value)
        {
            return self.Value < value.Value;
        }
        ...
        /// <returns> The result of the operation. </returns>
        public static explicit operator BigInteger(CompactInteger c)
        {
            return c.Value;
        }
        ...
        /// <returns> The result of the operation. </returns>
        public static implicit operator CompactInteger(BigInteger b)
        {
            return new CompactInteger(b);
        }
        ...
        /// <returns> The result of the operation. </returns>
        public static implicit operator CompactInteger(sbyte i)
        {
        ...
        /// <param name="i"> Zero-based index of the. </param>
        /// <returns> The result of the operation. </returns>
        public static implicit operator CompactInteger(byte i)
        {
            return new CompactInteger(i);
        }
        ...
        /// <param name="i"> Zero-based index of the. </param>
        /// <returns> The result of the operation. </returns>
        public static implicit operator CompactInteger(short i)
        {
            return new CompactInteger(i);
        }
        ...
        /// <param name="i"> Zero-based index of the. </param>
        /// <returns> The result of the operation. </returns>
        public static implicit operator CompactInteger(ushort i)
        {
            return new CompactInteger(i);
        }
        ...
        /// <param name="i"> Zero-based index of the. </param>
        /// <returns> The result of the operation. </returns>
        public static implicit operator CompactInteger(int i)
        {
            return new CompactInteger(i);
        }
        ...
        /// <param name="i"> Zero-based index of the. </param>
        /// <returns> The result of the operation. </returns>
        public static implicit operator CompactInteger(uint i)
        {
            return new CompactInteger(i);
        }
        ...
        /// <param name="i"> Zero-based index of the. </param>
        /// <returns> The result of the operation. </returns>
        public static implicit operator CompactInteger(long i)
        {
            return new CompactInteger(i);
        }
        ...
        /// <param name="i"> Zero-based index of the. </param>
        /// <returns> The result of the operation. </returns>
        public static implicit operator CompactInteger(ulong i)
        {
            return new CompactInteger(i);
        }
